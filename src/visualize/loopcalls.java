...
public class loopcalls {
	 public static String readFileAsString(String fileName) throws Exception {
	  ...
	  public static void functioncalls(String data) throws Exception {
	         ...
	         while(m.find()) {
	             ...
	             if(!theGroup.matches("(while|println|print|for|if|else if).*"))
	             {
	 ...
	 public static void main(String[] args) throws Exception {
	        String data = readFileAsString("/home/kuttattu/eclipse-workspace/visualize/src/visualize/sqsum.scala");
